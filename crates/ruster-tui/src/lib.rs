...
mod tests {
    ...
    fn tui_renderer_accepts_frame_state() {
        ...
        let state = FrameState { windows: vec![view], cmdline: None, message: None, picker: None, whichkey: None, cmdline_completions: None, hover: None, settings: None, welcome: None };
