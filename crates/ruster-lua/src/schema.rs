...
pub fn schema() -> Vec<SettingSpec> {
    ...
    add("colors", "whichkey_bg", "Which-key bg", Text, t(""), "Which-key panel background (empty = cmdline bg)");
    add("colors", "whichkey_fg", "Which-key fg", Text, t(""), "Which-key panel text (empty = cmdline fg)");
    add("colors", "whichkey_key", "Which-key key", Text, t(""), "Key-letter highlight in which-key / completions");
    add("colors", "cmdline_bg", "Cmdline bg", Text, t(""), "Cmdline prompt bar background (empty = divider)");
    add("colors", "cmdline_fg", "Cmdline fg", Text, t(""), "Cmdline prompt text (empty = theme fg)");
