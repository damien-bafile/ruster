...
pub fn palette(entries: &[(&str, &str)]) -> Vec<(String, Rgb)> {
    entries
        .iter()
        .map(|(n, h)| (n.to_string(), hex_to_rgb(h)))
        .collect()
}
...
pub fn mocha_roles() -> ThemeColors {
    ThemeColors {
        ...
        mode_insert_fg: Rgb::new(205, 214, 244),
        mode_visual_bg: Rgb::new(55, 35, 70),
        mode_visual_fg: Rgb::new(205, 214, 244),
        mode_cmdline_bg: Rgb::new(49, 50, 68),
        mode_cmdline_fg: Rgb::new(205, 214, 244),
        mode_emacs_bg: Rgb::new(40, 45, 60),
        mode_emacs_fg: Rgb::new(205, 214, 244),
    }
}
        ...
        (
            ...
            Theme {
                palette: palette(&[
                    ...
                    ("phosphor_dim", "#1a6633"),
                    ("phosphor_bright", "#66ff99"),
                    ("amber", "#ff8800"),
                    ("amber_dim", "#664400"),
                    ("panel_offwhite", "#ccbbaa"),
                    ("panel_gray", "#222a22"),
                    ("stencil", "#88aa88"),
                    ("hazard_red", "#ff3333"),
                ]),
                roles: ThemeColors {
                    bg: Rgb::new(10, 14, 10),
                    fg: Rgb::new(51, 255, 102),
                    gutter: Rgb::new(26, 102, 51),
                    gutter_bg: Rgb::new(10, 14, 10),
                    cursor_bg: Rgb::new(102, 255, 153),
                    cursor_fg: Rgb::new(10, 14, 10),
                    selection_bg: Rgb::new(88, 91, 112),
                    selection_fg: Rgb::new(51, 255, 102),
                    divider: Rgb::new(17, 26, 17),
                    statusline_fg: Rgb::new(51, 255, 102),
                    statusline_bg: Rgb::new(17, 26, 17),
                    accent: Rgb::new(255, 136, 0),
                    accent_fg: Rgb::new(10, 14, 10),
                    whichkey_bg: Rgb::new(10, 14, 10),
                    whichkey_fg: Rgb::new(51, 255, 102),
                    ...
                    mode_insert_fg: Rgb::new(51, 255, 102),
                    mode_visual_bg: Rgb::new(40, 20, 20),
                    mode_visual_fg: Rgb::new(51, 255, 102),
                    mode_cmdline_bg: Rgb::new(17, 26, 17),
                    mode_cmdline_fg: Rgb::new(51, 255, 102),
                    mode_emacs_bg: Rgb::new(17, 26, 17),
                    mode_emacs_fg: Rgb::new(51, 255, 102),
                },
            },
        ),
        (
        ...
        (
            ...
            Theme {
                ...
                roles: ThemeColors {
                    ...
                    gutter_bg: Rgb::new(40, 40, 40),
                    cursor_bg: Rgb::new(254, 128, 25),
                    cursor_fg: Rgb::new(40, 40, 40),
                    selection_bg: Rgb::new(88, 91, 112),
                    selection_fg: Rgb::new(235, 219, 178),
                    divider: Rgb::new(60, 56, 54),
                    statusline_fg: Rgb::new(235, 219, 178),
                    statusline_bg: Rgb::new(60, 56, 54),
                    accent: Rgb::new(250, 189, 47),
                    accent_fg: Rgb::new(40, 40, 40),
                    whichkey_bg: Rgb::new(40, 40, 40),
                    whichkey_fg: Rgb::new(235, 219, 178),
                    ...
                    mode_insert_fg: Rgb::new(235, 219, 178),
                    mode_visual_bg: Rgb::new(60, 40, 50),
                    mode_visual_fg: Rgb::new(235, 219, 178),
                    mode_cmdline_bg: Rgb::new(60, 56, 54),
                    mode_cmdline_fg: Rgb::new(235, 219, 178),
                    mode_emacs_bg: Rgb::new(50, 50, 65),
                    mode_emacs_fg: Rgb::new(235, 219, 178),
                },
            },
        ),
        (
            ...
            Theme {
                ...
                roles: ThemeColors {
                    ...
                    gutter_bg: Rgb::new(26, 27, 38),
                    cursor_bg: Rgb::new(192, 202, 245),
                    cursor_fg: Rgb::new(26, 27, 38),
                    selection_bg: Rgb::new(88, 91, 112),
                    selection_fg: Rgb::new(192, 202, 245),
                    divider: Rgb::new(65, 72, 104),
                    statusline_fg: Rgb::new(192, 202, 245),
                    statusline_bg: Rgb::new(65, 72, 104),
                    accent: Rgb::new(122, 162, 247),
                    accent_fg: Rgb::new(26, 27, 38),
                    whichkey_bg: Rgb::new(30, 30, 46),
                    whichkey_fg: Rgb::new(192, 202, 245),
                    ...
                    mode_insert_bg: Rgb::new(40, 72, 50),
                    mode_insert_fg: Rgb::new(192, 202, 245),
                    mode_visual_bg: Rgb::new(65, 50, 80),
                    mode_visual_fg: Rgb::new(192, 202, 245),
                    mode_cmdline_bg: Rgb::new(65, 72, 104),
                    mode_cmdline_fg: Rgb::new(192, 202, 245),
                    mode_emacs_bg: Rgb::new(50, 60, 90),
                    mode_emacs_fg: Rgb::new(192, 202, 245),
                },
            },
        ),
        (
            ...
            Theme {
                ...
                roles: ThemeColors {
                    ...
                    gutter_bg: Rgb::new(46, 52, 64),
                    cursor_bg: Rgb::new(136, 192, 208),
                    cursor_fg: Rgb::new(46, 52, 64),
                    selection_bg: Rgb::new(88, 91, 112),
                    selection_fg: Rgb::new(216, 222, 233),
                    divider: Rgb::new(59, 66, 82),
                    statusline_fg: Rgb::new(216, 222, 233),
                    statusline_bg: Rgb::new(59, 66, 82),
                    accent: Rgb::new(136, 192, 208),
                    accent_fg: Rgb::new(46, 52, 64),
                    whichkey_bg: Rgb::new(46, 52, 64),
                    whichkey_fg: Rgb::new(216, 222, 233),
                    ...
                    mode_insert_fg: Rgb::new(216, 222, 233),
                    mode_visual_bg: Rgb::new(66, 45, 80),
                    mode_visual_fg: Rgb::new(216, 222, 233),
                    mode_cmdline_bg: Rgb::new(59, 66, 82),
                    mode_cmdline_fg: Rgb::new(216, 222, 233),
                    mode_emacs_bg: Rgb::new(50, 55, 75),
                    mode_emacs_fg: Rgb::new(216, 222, 233),
                },
            },
        ),
        (
        ...
        (
            ...
            Theme {
                ...
                roles: ThemeColors {
                    ...
                    fg: Rgb::new(76, 79, 105),
                    gutter: Rgb::new(156, 160, 176),
                    gutter_bg: Rgb::new(239, 241, 245),
                    cursor_bg: Rgb::new(220, 138, 120),
                    cursor_fg: Rgb::new(239, 241, 245),
                    selection_bg: Rgb::new(172, 176, 190),
                    selection_fg: Rgb::new(76, 79, 105),
                    divider: Rgb::new(204, 208, 218),
                    statusline_fg: Rgb::new(76, 79, 105),
                    statusline_bg: Rgb::new(230, 233, 239),
                    accent: Rgb::new(136, 57, 239),
                    accent_fg: Rgb::new(239, 241, 245),
                    whichkey_bg: Rgb::new(239, 241, 245),
                    whichkey_fg: Rgb::new(76, 79, 105),
                    ...
                    mode_insert_fg: Rgb::new(76, 79, 105),
                    mode_visual_bg: Rgb::new(230, 215, 240),
                    mode_visual_fg: Rgb::new(76, 79, 105),
                    mode_cmdline_bg: Rgb::new(230, 233, 239),
                    mode_cmdline_fg: Rgb::new(76, 79, 105),
                    mode_emacs_bg: Rgb::new(215, 225, 240),
                    mode_emacs_fg: Rgb::new(76, 79, 105),
                },
            },
        ),
        (
            ...
            Theme {
                ...
                roles: ThemeColors {
                    bg: Rgb::new(48, 52, 70),
                    fg: Rgb::new(198, 208, 245),
                    gutter: Rgb::new(115, 121, 148),
                    gutter_bg: Rgb::new(48, 52, 70),
                    cursor_bg: Rgb::new(242, 213, 207),
                    cursor_fg: Rgb::new(48, 52, 70),
                    selection_bg: Rgb::new(98, 104, 128),
                    selection_fg: Rgb::new(198, 208, 245),
                    divider: Rgb::new(65, 69, 89),
                    statusline_fg: Rgb::new(198, 208, 245),
                    statusline_bg: Rgb::new(65, 69, 89),
                    accent: Rgb::new(202, 158, 230),
                    accent_fg: Rgb::new(48, 52, 70),
                    whichkey_bg: Rgb::new(48, 52, 70),
                    whichkey_fg: Rgb::new(198, 208, 245),
                    ...
                    mode_insert_fg: Rgb::new(198, 208, 245),
                    mode_visual_bg: Rgb::new(65, 45, 75),
                    mode_visual_fg: Rgb::new(198, 208, 245),
                    mode_cmdline_bg: Rgb::new(65, 69, 89),
                    mode_cmdline_fg: Rgb::new(198, 208, 245),
                    mode_emacs_bg: Rgb::new(55, 60, 75),
                    mode_emacs_fg: Rgb::new(198, 208, 245),
                },
            },
        ),
        (
            ...
            Theme {
                ...
                roles: ThemeColors {
                    bg: Rgb::new(36, 39, 58),
                    fg: Rgb::new(202, 211, 245),
                    gutter: Rgb::new(110, 115, 141),
                    gutter_bg: Rgb::new(36, 39, 58),
                    cursor_bg: Rgb::new(244, 219, 214),
                    cursor_fg: Rgb::new(36, 39, 58),
                    selection_bg: Rgb::new(91, 96, 120),
                    selection_fg: Rgb::new(202, 211, 245),
                    divider: Rgb::new(54, 58, 79),
                    statusline_fg: Rgb::new(202, 211, 245),
                    statusline_bg: Rgb::new(54, 58, 79),
                    accent: Rgb::new(198, 160, 246),
                    accent_fg: Rgb::new(36, 39, 58),
                    whichkey_bg: Rgb::new(36, 39, 58),
                    whichkey_fg: Rgb::new(202, 211, 245),
                    ...
                    mode_insert_fg: Rgb::new(202, 211, 245),
                    mode_visual_bg: Rgb::new(55, 40, 70),
                    mode_visual_fg: Rgb::new(202, 211, 245),
                    mode_cmdline_bg: Rgb::new(54, 58, 79),
                    mode_cmdline_fg: Rgb::new(202, 211, 245),
                    mode_emacs_bg: Rgb::new(45, 50, 65),
                    mode_emacs_fg: Rgb::new(202, 211, 245),
                },
            },
        ),
    ]
...
impl Config {
    ...
    pub fn to_settings(&self) -> Vec<(Addr, crate::schema::SettingValue)> {
        ...
        vec![
            ...
            (
                ("gui", "font"),
                Text(self.gui_font.clone().unwrap_or_default()),
            ),
            ...
            (
                ("gui", "cursor_anim_speed"),
                Float(self.cursor_anim_speed as f64),
            ),
            ...
            (
                ("whichkey", "command_palette"),
                Enum(self.command_palette.clone()),
            ),
            ...
            (
                ("terminal", "shell"),
                Text(self.terminal_shell.clone().unwrap_or_default()),
            ),
            (
                ("terminal", "scrollback"),
                Int(self.terminal_scrollback as i64),
            ),
            (
                ("terminal", "default_mode"),
                Enum(self.terminal_default_mode.clone()),
            ),
            ...
            (
                ("colors", "gutter"),
                Text(self.color_overrides.gutter.clone()),
            ),
            (
                ("colors", "gutter_bg"),
                Text(self.color_overrides.gutter_bg.clone()),
            ),
            (
                ("colors", "cursor_bg"),
                Text(self.color_overrides.cursor_bg.clone()),
            ),
            (
                ("colors", "selection_bg"),
                Text(self.color_overrides.selection_bg.clone()),
            ),
            (
                ("colors", "selection_fg"),
                Text(self.color_overrides.selection_fg.clone()),
            ),
            (
                ("colors", "cursor_fg"),
                Text(self.color_overrides.cursor_fg.clone()),
            ),
            (
                ("colors", "divider"),
                Text(self.color_overrides.divider.clone()),
            ),
            (
                ("colors", "statusline_fg"),
                Text(self.color_overrides.statusline_fg.clone()),
            ),
            (
                ("colors", "statusline_bg"),
                Text(self.color_overrides.statusline_bg.clone()),
            ),
            (
                ("colors", "accent"),
                Text(self.color_overrides.accent.clone()),
            ),
            (
                ("colors", "accent_fg"),
                Text(self.color_overrides.accent_fg.clone()),
            ),
            (
                ("colors", "whichkey_bg"),
                Text(self.color_overrides.whichkey_bg.clone()),
            ),
            (
                ("colors", "whichkey_fg"),
                Text(self.color_overrides.whichkey_fg.clone()),
            ),
            (
                ("colors", "whichkey_key"),
                Text(self.color_overrides.whichkey_key.clone()),
            ),
            (
                ("colors", "cmdline_accent"),
            ...
            (
                ("colors", "cmdline_fg"),
                Text(self.color_overrides.cmdline_fg.clone()),
            ),
            (
                ("colors", "mode_normal_bg"),
                Text(self.color_overrides.mode_normal_bg.clone()),
            ),
            (
                ("colors", "mode_normal_fg"),
                Text(self.color_overrides.mode_normal_fg.clone()),
            ),
            (
                ("colors", "mode_insert_bg"),
                Text(self.color_overrides.mode_insert_bg.clone()),
            ),
            (
                ("colors", "mode_insert_fg"),
                Text(self.color_overrides.mode_insert_fg.clone()),
            ),
            (
                ("colors", "mode_visual_bg"),
                Text(self.color_overrides.mode_visual_bg.clone()),
            ),
            (
                ("colors", "mode_visual_fg"),
                Text(self.color_overrides.mode_visual_fg.clone()),
            ),
            (
                ("colors", "mode_cmdline_bg"),
                Text(self.color_overrides.mode_cmdline_bg.clone()),
            ),
            (
                ("colors", "mode_cmdline_fg"),
                Text(self.color_overrides.mode_cmdline_fg.clone()),
            ),
            (
                ("colors", "mode_emacs_bg"),
                Text(self.color_overrides.mode_emacs_bg.clone()),
            ),
            (
    ...
    pub fn from_settings(vals: &[(Addr, crate::schema::SettingValue)]) -> Config {
        ...
        Config {
            ...
            terminal_default_mode: st("terminal", "default_mode")
                .unwrap_or(d.terminal_default_mode),
            ...
            noice: NoiceConfig {
                ...
                success_timeout_ms: u(
                    "noice",
                    "success_timeout",
                    d.noice.success_timeout_ms as u32,
                ) as u64,
                warning_timeout_ms: u(
                    "noice",
                    "warning_timeout",
                    d.noice.warning_timeout_ms as u32,
                ) as u64,
...
mod tests {
    ...
    fn the_default_theme_is_catppuccin_mocha() {
        ...
        assert_eq!(
            schema_default,
            crate::schema::SettingValue::Text("catppuccin-mocha".into())
        );

        assert!(
            builtin_themes()
                .iter()
                .any(|(n, _)| *n == "catppuccin-mocha"),
